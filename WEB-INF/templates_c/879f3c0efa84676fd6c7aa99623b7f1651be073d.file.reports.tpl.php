<?php /* Smarty version Smarty-3.0.7, created on 2015-03-19 02:31:44
         compiled from "/home/alltic/public_html/time/WEB-INF/templates/reports.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1515149180550a3510b72f77-61720158%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '879f3c0efa84676fd6c7aa99623b7f1651be073d' => 
    array (
      0 => '/home/alltic/public_html/time/WEB-INF/templates/reports.tpl',
      1 => 1426047566,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1515149180550a3510b72f77-61720158',
  'function' => 
  array (
  ),
...
<?php if (in_array('cl',explode(',',$_smarty_tpl->getVariable('user')->value->plugins))||in_array('iv',explode(',',$_smarty_tpl->getVariable('user')->value->plugins))){?>          
  ...
  <?php if (in_array('cl',explode(',',$_smarty_tpl->getVariable('user')->value->plugins))){?>
                <td width="25%"><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chclient']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['client'];?>
  ...
  <?php if (($_smarty_tpl->getVariable('user')->value->canManageTeam()||$_smarty_tpl->getVariable('user')->value->isClient())&&in_array('iv',explode(',',$_smarty_tpl->getVariable('user')->value->plugins))){?>
                <td width="25%"><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chinvoice']['control'];?>
...
<?php }?>            
              <tr>
                <td width="25%"><?php if ((@MODE_PROJECTS==$_smarty_tpl->getVariable('user')->value->tracking_mode||@MODE_PROJECTS_AND_TASKS==$_smarty_tpl->getVariable('user')->value->tracking_mode)){?><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chproject']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['project'];?>
<?php }?></td>
                <td width="25%"><?php if (((@TYPE_START_FINISH==$_smarty_tpl->getVariable('user')->value->record_type)||(@TYPE_ALL==$_smarty_tpl->getVariable('user')->value->record_type))){?><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chstart']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['start'];?>
<?php }?></td>
                <td width="25%"><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chduration']['control'];?>
...
<?php if (((($_smarty_tpl->getVariable('user')->value->canManageTeam()||$_smarty_tpl->getVariable('user')->value->isClient())||in_array('ex',explode(',',$_smarty_tpl->getVariable('user')->value->plugins)))&&defined('COST_ON_REPORTS')&&isTrue(@COST_ON_REPORTS))){?>
                  <td width="25%"><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chcost']['control'];?>
...
<?php }?>
              ...
              <tr>
              	<td><?php if ((@MODE_PROJECTS_AND_TASKS==$_smarty_tpl->getVariable('user')->value->tracking_mode)){?><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chtask']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['task'];?>
<?php }?></td>
              	<td><?php if (((@TYPE_START_FINISH==$_smarty_tpl->getVariable('user')->value->record_type)||(@TYPE_ALL==$_smarty_tpl->getVariable('user')->value->record_type))){?><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chfinish']['control'];?>
&nbsp;<?php echo $_smarty_tpl->getVariable('i18n')->value['label']['finish'];?>
<?php }?></td>
                <td><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chnote']['control'];?>
...
<?php if (($_smarty_tpl->getVariable('custom_fields')->value&&$_smarty_tpl->getVariable('custom_fields')->value->fields[0])){?>
                <td><?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chcf_1']['control'];?>
...
<?php }?>
 ...
 <?php echo $_smarty_tpl->getVariable('forms')->value['reportForm']['chtotalsonly']['control'];?>
